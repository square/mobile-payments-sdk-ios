...
3. Select the `Exact Version` dependency rule and specify the version as `2.2.0`.
...
pod "SquareMobilePaymentsSDK", "~> 2.2.0"
...
pod "MockReaderUI", "~> 2.2.0", configurations: ['Debug']
```
